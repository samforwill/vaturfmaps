...
show_labels = st.checkbox("Show precinct labels") 

if show_labels and len(filtered_features) > 0:
        # Add precinct name markers at precomputed centroid points
...
if len(filtered_metrics) > 0:
    ...
    placeholder_turfs = ["R01C - Placeholder1", "R07D - Placeholder2", "R07F - Placeholder3", "R09F - South"]
    all_turfs = sorted(set(st.session_state.master_df['Current Turf'].unique()).union(placeholder_turfs))
